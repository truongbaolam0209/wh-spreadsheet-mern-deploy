...
const ButtonAdminUploadRowsHistory = () => {
    ...
    return (
        <>
            {file ? (
                <Tooltip title='Upload Data Rows History'>
                    <Icon type='rise' onClick={uploadCurrentDataToServer} style={{ marginRight: 10 }} />
                </Tooltip>
            ) : (
...
export default ButtonAdminUploadRowsHistory;
